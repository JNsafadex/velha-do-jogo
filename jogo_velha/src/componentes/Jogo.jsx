...
const Jogo = () => {
    ...
    const voltarJogada = (i) => {
        setVezJogador(i%2 ==0 ? 'O': 'X')
        setEstadoTabuleiro(historicoJogadas[i])
        setHistoricoJogadas(historicoJogadas.filter((v,j)=> j<=i))
    }
    const reiniciarJogo = () => {
        setVezJogador('X')
    ...
    return (
        <div className='jogo'>
            ...
            <Rodape historico={historicoJogadas} func={voltarJogada}/>
        </div>
    )
}
